...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/underscore/underscore.js":[function(require,module,exports) {
var global = arguments[3];
var define;
//     Underscore.js 1.9.1
...
},{}],"../node_modules/underscore.string/lib/underscore.string.js":[function(require,module,exports) {
var define;
//  Underscore.string
...
},{}],"../node_modules/backbone/backbone.js":[function(require,module,exports) {
//     Backbone.js 0.9.10
...
},{"underscore":"../node_modules/underscore/underscore.js"}],"../node_modules/kjantzer-backbone-subviews/src.js":[function(require,module,exports) {
/*
	Backbone Subviews 0.6.1
...
},{}],"../node_modules/kjantzer-backbone-subviews/index.js":[function(require,module,exports) {
'use strict';
...
var _src = require('kjantzer-backbone-subviews/src');

var _src2 = _interopRequireDefault(_src);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

Object.assign(_backbone2.default.View.prototype, _src2.default);
},{"backbone":"../node_modules/backbone/backbone.js","kjantzer-backbone-subviews/src":"../node_modules/kjantzer-backbone-subviews/src.js"}],"../node_modules/backbone-dropdown/src/views/text.js":[function(require,module,exports) {
...
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/backbone-dropdown/src/views/date-picker.js":[function(require,module,exports) {
...
},{"backbone":"../node_modules/backbone/backbone.js"}],"../node_modules/backbone-dropdown/src/views/input-select.js":[function(require,module,exports) {
...
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../node_modules/liquidmetal/liquidmetal.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/**
...
},{}],"../node_modules/backbone-dropdown/src/views/menu.js":[function(require,module,exports) {

const Backbone = require('backbone')
const $ = require('jquery')
const MenuDatePickerView = require('./date-picker')
const MenuInputSelectView = require('./input-select')
...
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js","./date-picker":"../node_modules/backbone-dropdown/src/views/date-picker.js","./input-select":"../node_modules/backbone-dropdown/src/views/input-select.js","liquidmetal":"../node_modules/liquidmetal/liquidmetal.js"}],"../node_modules/backbone-dropdown/src/dropdown.js":[function(require,module,exports) {
/*
    Dropdown view
...
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js","./views/text":"../node_modules/backbone-dropdown/src/views/text.js","./views/menu":"../node_modules/backbone-dropdown/src/views/menu.js","./views/input-select":"../node_modules/backbone-dropdown/src/views/input-select.js"}],"../node_modules/backbone-dropdown/src/jquery-plugin.js":[function(require,module,exports) {
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","./dropdown":"../node_modules/backbone-dropdown/src/dropdown.js"}],"../src/Sounds.js":[function(require,module,exports) {
...
var path = '/app/resources/sounds/'; // absolute path to audio files
...
module.exports = function () {
	...
	_createClass(Sounds, null, [{
		...
		value: function play(soundName) {
			...
			if (!sound) sound = aliases[soundName] && sounds[aliases[soundName]];
...
var Util = {
    ...
    permission: function permission(_permission) {
        return User.can(_permission);
    },

    store: function store(key, val) {
        if (val === undefined) return localStorage.getItem(key);else return val === null ? localStorage.removeItem(key) : localStorage.setItem(key, val);
    },


    nearestQuarter: function nearestQuarter(num) {
        return Number((Math.round(num * 4) / 4).toFixed(2));
    },

    displayIf: function displayIf(_displayIf) {

        switch (_displayIf) {

            case 'not-new':
            case '!new':
                if (!this.model || this.model.isNew()) return false;
                break;
            ...
            default:
                if (typeof _displayIf == 'function' && !_displayIf.call(this)) return false;
                break;
        }
    ...
    addBtn: function addBtn(btnOpts, $appendTo) {
        ...
        if (btn.displayIf && !Util.displayIf.call(this, btn.displayIf)) return;

        // dont add button if user does not have permission
        if (btn.permission && !Util.permission(btn.permission)) return;
        ...
        if (btn.icon) $btn.addClass('icon-' + btn.icon);

        if (btn.disabled) $btn.addClass('disabled');else if (btn.toggleIf) btn.toggleIf.call(this, $btn) ? $btn.addClass('disabled') : null;
        ...
        if (btn.onClick) {
            ...
            if (typeof btn.onClick == 'function') onClickFn = btn.onClick.bind(this);

            // look for method matching string name
            else if (typeof btn.onClick == 'string' && this[btn.onClick]) onClickFn = this[btn.onClick].bind(this);

                // look for method on root view matching string name
                else if (typeof btn.onClick == 'string' && this.view && this.view[btn.onClick]) onClickFn = this.view[btn.onClick].bind(this.view);

            if (onClickFn) $btn.click(function (e) {
    ...
    isFullscreen: function isFullscreen(el) {
    ...
    toggleFullscreen: function toggleFullscreen(el, callback) {

        var body = document.body;

        // fullscreen API not supported, use fallback if given
        if (!body.requestFullscreen && !body.webkitRequestFullScreen && !body.msRequestFullscreen && !body.mozRequestFullScreen) {
        ...
        if (!document.fullscreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement && !document.mozFullScreenElement) {
            if (el.requestFullscreen) el.requestFullscreen();else if (el.msRequestFullscreen) el.msRequestFullscreen();else if (el.mozRequestFullScreen) el.mozRequestFullScreen();else if (el.webkitRequestFullscreen) el.webkitRequestFullscreen();
        } else {
        ...
        var fullscreenChange = function fullscreenChange() {
            var _el = document.fullscreenElement || document.webkitFullscreenElement || document.msFullscreenElement || document.mozFullScreenElement;

            if (!_el) document.removeEventListener(changeEvent, fullscreenChange);
...
module.exports = Util;
},{"./Sounds":"../src/Sounds.js"}],"../src/View.js":[function(require,module,exports) {
...
module.exports = Backbone.View.extend({
    ...
    realtimeBadgeAppendTo: function realtimeBadgeAppendTo() {
    ...
    initialize: function initialize() {
        ...
        if (this.model && this.setModel) this.setModel(this.model);

        if (this.collection && this.setCollection) this.setCollection(this.collection);
    },
    ...
    render: function render() {
        ...
        var args = arguments;
        _.defer(function () {
            _this.forEachView(function (view) {
    ...
    forEachView: function forEachView(fnAction) {
        if (fnAction) _.each(this.views, function (v, vName) {
            this.sv(vName) && fnAction(this.sv(vName));
        }.bind(this));
    },
    ...
    _setupRootView: function _setupRootView() {
        var _this2 = this;
        ...
        if (this.rootViews) _.each(this.rootViews, function (v, viewName) {

            if (!v.view) return;

            _this2._setSubview(viewName, v.view);

            if (viewName == location.hash.slice(1).split('/')[0]) {
                setTimeout(function () {
                    return _this2.openSubview(viewName);
                }, 500);
            }
        });
        ...
        if (this.options.rootView) {
            views.view = this.options.rootView;
        }
        if (this.options.sidebarView) {
            views.sidebar = this.options.sidebarView;
        }
        ...
        _.each(views, function (v, vName) {
            ...
            if (vName == 'view' && !this.view) {
                ...
                if (this.view.appendTo) this.view.appendTo(this.$el);else this.$el.append(this.view.$wrap || this.view.el);

                this._setupMethods && this._setupMethods(); // deprectated

                if (this.hasSummary && this.hasSummary() && this.summaryChangeEvents) this.listenTo(this.view, this.summaryChangeEvents, this._updateSummary);
            }
    ...
    // ! DEPRECATED
    _setupMethods: function _setupMethods() {
        ...
        if (this.methods && !this._didSetupMethods) {
            ...
            _.each(this.methods, function (methodName) {
                ...
                if (this[methodName]) console.warn('Whoops! Looks like this SheetView already has a method called: “' + methodName + '”');else if (!this.view[methodName]) console.error('The root view for this SheetView does not have a method called: “' + methodName + '”');else proto[methodName] = function () {
                    this.view[methodName].apply(this.view, arguments);
                }.bind(this);
            }.bind(this));
        }
    },
    ...
    _renderToolbar: function _renderToolbar() {
        ...
        if (!this.$toolbar) this.$toolbar = $('<div class="' + this.className + '"></div>');

        this.$toolbar.empty();

        this.$toolbar.append(this.toolbarTitle());

        if (this.realtimeViewID) this.renderRealtimeConnectionsBadge();

        if (this.renderToolbar) _.defer(this.renderToolbar.bind(this));
        ...
        if (this.showSaveBtn) $('<a class="btn green left close-sheet">Save</a>').appendTo(this.$toolbar).click(this.save.bind(this));

        if (this.showCloseBtn && !this.showSaveBtn) $('<a class="btn left close-sheet icon-cancel"></a>').appendTo(this.$toolbar).click(function () {
            _this3.btnSounds && Sounds.play(_this3.btnSounds === true ? 'appear' : _this3.btnSounds, 0.25);
            _this3.close();
        });else if (this.showCloseBtn && this.showSaveBtn) $('<a class="btn left close-sheet">Cancel</a>').appendTo(this.$toolbar).click(this.cancel.bind(this));
    ...
    _renderBtns: function _renderBtns() {

        if (this.btns) var btns = _.isFunction(this.btns) ? this.btns() : this.btns;
        _.each(btns, function (btn) {

            btn.sound = btn.sound || this.btnSounds;

            if (btn == 'divider' || btn.divider != undefined) this.$toolbar.append('<div class="btn-divider ' + (btn.className || '') + '"></div>');else if (btn.group) this._renderBtnGroup(btn);else App.Util.addBtn.call(this, btn, btn.titleBtn == true ? this.$toolbar.find('h4') : this.$toolbar);
        }.bind(this));
    ...
    _renderBtnGroup: function _renderBtnGroup(btnGroup) {
    ...
    save: function save() {
        ...
        if (this.view && this.view.save) {
            if (this.view.save() === true) this.close();
        } else if (this.editor) {

            var success = this.model.isNew() && this.collection ? function () {
    ...
    renderRealtimeConnectionsBadge: function renderRealtimeConnectionsBadge() {

        // realtime not yet defined, retry in 300 ms
        if (typeof realtime == 'undefined') {
            setTimeout(this.renderRealtimeConnectionsBadge.bind(this), 300);
        } else {
            this.subview('realtimeConnectionsBadge', new BSA.Views.RealtimeConnectionsBadge({ realtimeKey: 'view:' + (_.isFunction(this.realtimeViewID) ? this.realtimeViewID() : this.realtimeViewID) + ':connections' }));

            this.realtimeBadgeAppendTo().append(this.subview('realtimeConnectionsBadge').render().el);
        }
    },

    toolbarTitleMenu: function toolbarTitleMenu() {
        return false;
    },
    ...
    showToolbarTitleMenu: function showToolbarTitleMenu() {
        this.toolbarTitleMenuDD.open();
        // this.$toolbar.find('h4').data('dropdown').open();
    },

    hideToolbarTitleMenu: function hideToolbarTitleMenu() {
        this.toolbarTitleMenuDD.close();
        // this.$toolbar.find('h4').data('dropdown').close();
    },

    toggleToolbarTitleMenu: function toggleToolbarTitleMenu() {
        this.toolbarTitleMenuDD.toggle();
        // this.$toolbar.find('h4').data('dropdown').toggle();
    },

    openToolbarTitleMenu: function openToolbarTitleMenu() {
        this.showToolbarTitleMenu();
    },
    closeToolbarTitleMenu: function closeToolbarTitleMenu() {
        this.hideToolbarTitleMenu();
    },

    spin: function spin(keepSpinning) {

        if (!this.$toolbar) return;

        if (keepSpinning === false) this.$toolbar.spin(false);else this.$toolbar.spin('small');
    },
    ...
    cleanup: function cleanup() {
        ...
        if (scrollView) this.scrollTop = scrollView.scrollTop;
    ...
    scrollToElement: function scrollToElement(id, animated) {

        var el = (typeof id === 'undefined' ? 'undefined' : _typeof(id)) == 'object' ? id : document.getElementById('section-' + id);
    ...
    scrollTo: function scrollTo(offset, animated) {
        ...
        if (animated) scrollView.smoothScrollTo(offset);else scrollView.scrollTop = offset;
    },

    /*
        Progress - sets progress bar in the view toolbar; when both counts are equal, the progressbar will hide
    */
    progress: function progress(count, loadedCount, showPercent) {

        if (isNaN(count) || isNaN(loadedCount)) return;

        if (showPercent !== false && showPercent !== true && this.progressType == 'percent') showPercent = true;
        ...
        var percent = Util.nearestQuarter(loadedCount / count * 100);
        ...
        if (showPercent) this.$progressbarCount.html('<span>Loading (' + percent + '%)</span>');else this.$progressbarCount.html('<span>Loading ' + loadedCount + ' of ' + count + '</span>');
    ...
    _updateSummary: function _updateSummary() {
        ...
        if (data) this.$summary.html(_.template(this.summaryTemplate, data));
    }
...
Element.prototype.smoothScrollTo = function (target, duration) {
    ...
    var fn = function fn(position) {
        el.scrollTop = position;
    };

    animation(fn, duration, start, target);
};
},{"./Sounds":"../src/Sounds.js","./Util":"../src/Util.js"}],"../src/MenuControllerView.js":[function(require,module,exports) {
/*
...
module.exports = Backbone.View.extend({
    ...
    setModel: function setModel(model) {
        ...
        if (this.view && this.view.setModel) this.view.setModel(model);

        _.each(this.__subviews, function (view) {
            if (view && view.setModel) view.setModel(model);
        });
    ...
    reRender: function reRender() {
        if (this.isVisible() && this.inDOM()) this.render();
    },
    ...
    render: function render() {
        ...
        if (this.view || _.size(this.views) > 0) _.defer(function () {
            View.prototype.forEachView.call(this, function (view) {
                view.render.apply(view, args);
            });
            // this.view.render.apply(this.view, args)
        }.bind(this));else if (this.template) this.renderTemplate();

        return this;
    },

    spin: function spin(doSpin) {
    ...
    appendTo: function appendTo($el) {
        if (this.$wrap) $el.append(this.$wrap);else console.warn("`_setupView` has not been called yet. use `render` first");
    },
    ...
    scrollToElement: function scrollToElement(el, animated) {
        this.scrollTo(el.offsetTop);
    },
...
},{"./View":"../src/View.js","./Util":"../src/Util.js"}],"../src/MenuController.js":[function(require,module,exports) {
/*
    Menu Controller
...
var MenuControllerView = require('./MenuControllerView');
var Util = require('./Util');
var Sounds = require('./Sounds');
...
module.exports = Backbone.View.extend({
    ...
    menuOrder: function menuOrder(newOrder) {
        var orderKey = 'MenuController:Order:' + (this.orderKey || this.className || this.__className);
        if (newOrder !== undefined) {
            Util.store(orderKey, newOrder);
        }
        return Util.store(orderKey);
    },
    ...
    setCollection: function setCollection(coll) {
        this.collection = coll;
        this.setViewCollections();
    },

    setViewModels: function setViewModels(model) {
    ...
    setViewCollections: function setViewCollections(coll) {
    ...
    _setupViews: function _setupViews() {
        ...
        this.views.forEach(function (d, indx) {
            ...
            if (v.setModel) v.setModel(this.model);

            if (v instanceof MenuControllerView) this.$views.append(v._setupView().$wrap);else this.$views.append(v.el);
        }.bind(this));
    ...
    _onViewSpin: function _onViewSpin(view, doSpin) {
    ...
    _setupMenu: function _setupMenu() {
        ...
        if (this.wrap) this.$el.addClass('af-menu-wrap');

        this.views.forEach(function (d, indx) {

            // defermine if the menu should be displayed
            if (d.displayIf && !Util.displayIf.call(this, d.displayIf)) return;
            ...
            if (d.attrs) d.$menu.attr(d.attrs);

            if (d.dropdown) d.$menu.addClass('has-action-menu');
        }.bind(this));
            ...
            if ($.fn.sortable) {
                this.$menu.sortable({
                    ...
                    update: function update(event, ui) {
                        var newOrder = Array.from(ui.item[0].parentElement.childNodes).map(function (el) {
                            return el.dataset.indx;
                        });
                        _this.menuOrder(newOrder);
                    }
                });
            } else {
    ...
    _resetMenuOrder: function _resetMenuOrder() {
        this.menuOrder(null);
        this._renderMenu();
    },
    ...
    _renderMenu: function _renderMenu() {
        ...
        if (menuOrder) {
            menuOrder.forEach(function (indx) {
                return _this2.views[indx] && _this2.views[indx].$menu && _this2.views[indx].$menu.appendTo(_this2.$menu);
            });
            // insert any remaining views (new views since last saved order)
            this.views.forEach(function (d, indx) {
                return menuOrder.indexOf(String(indx)) == -1 && d.$menu && d.$menu.appendTo(_this2.$menu);
            });

            // insert views in order they are defined
        } else {
            this.views.forEach(function (d) {
                if (d.$menu) d.$menu.appendTo(_this2.$menu);else if (d.permissionDenied !== true) // permission denied views wont have a $menu
                    _this2.$menu.append(d.View.render().el);
            });
        }
    },

    _onMenuContextMenu: function _onMenuContextMenu(e) {

        var indx = e.currentTarget.dataset.indx;
        var v = this.views[indx];

        // no view found, or current view is not the active one
        if (!v || indx != this._activeView()) return true;
    ...
    viewForHash: function viewForHash(name) {
    ...
    active: function active(key) {
        ...
        var d = this.views[this._activeView()];
        return key ? d[key] : d;
    },

    hashForActiveView: function hashForActiveView() {
        var view = this.views[this._activeView()];
        var hash = view.hash;
        if (view && view.View && view.View.hashForActiveView) hash += '/' + view.View.hashForActiveView();
        return hash;
    },

    loadView: function loadView(indx) {
        ...
        if (typeof indx == 'undefined') {
            ...
            if (typeof indx == 'undefined') indx = this._activeView();
        ...
        this.views.forEach(function (v) {
            ...
            if (v.View instanceof MenuControllerView) v.View && v.View._hide();else v.View.$el.removeClass('show');
        });

        if (oldView) {
            oldView.$menu && oldView.$menu.removeClass('active');

            if (oldView.View instanceof MenuControllerView) oldView.View && oldView.View._hide();else oldView.View.$el.removeClass('show');
        }

        newView.$menu && newView.$menu.addClass('active');

        if (newView.View instanceof MenuControllerView) newView.View && newView.View._show();else newView.View && newView.View.render().$el.addClass('show');
    },
    ...
    _activeView: function _activeView(indx) {
        ...
        if (typeof indx == 'undefined') {
            ...
            var indx = Util.store(key);

            // no stored active view
            if (indx == undefined) return this._firstAvailableView();

            // make sure the user is allowed to see the saved view
            var view = this.views[indx];
            if (view && (!view.permission || Util.permission(view.permission))) return indx;else return this._firstAvailableView();
    ...
    _firstAvailableView: function _firstAvailableView() {
        var defaultIndx = null;
        this.views.forEach(function (d, indx) {
            if (defaultIndx == null && (!d.permission || Util.permission(d.permission)) && (d.label || d.icon)) defaultIndx = indx;
        });
        return defaultIndx;
    }

});
},{"./MenuControllerView":"../src/MenuControllerView.js","./Util":"../src/Util.js","./Sounds":"../src/Sounds.js"}],"../src/SheetView.js":[function(require,module,exports) {
/*
    Sheet View
...
var SheetView = View.extend({
    ...
    setTitle: function setTitle() {
        if (this.isOnTop()) this.controller.setHash();
    ...
    setPath: function setPath(path) {
        ...
        if (_.isString(path)) path = path.replace(/^\/|\/$/g, '').split('/');

        if (path.length == 0) path = null;

        this.__path = path;
        if (this.view) this.view.__path = path;
    },

    // will always return an array
    getPath: function getPath() {
        var match = location.hash.match(RegExp('^#' + this.viewName + '\/?(.*)'));
        return match && match[1] ? match[1].split('/') : [];
    },

    open: function open(model, path) {

        this.setPath(path);

        if (model && model instanceof Backbone.Model && this.setModel) this.setModel(model);else if (model && model instanceof Backbone.Collection && this.setCollection) this.setCollection(model);

        this.setHeight('');

        if (this.isSplitView) this.isSplitView = false;

        // allow onOpen to cancel the opening of this view
        if (this.onOpen.apply(this, arguments) !== false) this.controller.open(this);
    },
    ...
    openInside: function openInside(model, sheetView) {
        ...
        if (!sheetView || !sheetView instanceof SheetView && sheetView !== this) return console.warn('No sheetView given');
    ...
    setHeight: function setHeight(h) {
        ...
        if (typeof h === 'undefined') h = this.splitView.h || '40%';
    ...
    _open: function _open() {
        ...
        if (this.setTitleOnOpen && this.isOpen) this.setTitle(this.setTitleOnOpen());

        this.realtimeOpen();
        this.onOpened();
    },

    realtimeOpen: function realtimeOpen() {
    ...
    realtimeClose: function realtimeClose() {
    ...
    _setView: function _setView() {
        ...
        if (this.w) this.$sheet.addClass('manual-width').css({ width: this.w + 'px' });

        if (this.h) this.$sheet.addClass('manual-height').css({ height: this.h + 'px' });

        if (this.centered || this.h) this.$sheet.addClass('centered');

        if (this.toolbarStyle) this.$sheet.addClass('toolbar-' + this.toolbarStyle);
    ...
    toggleFullscreen: function toggleFullscreen() {
        ...
        if (this.$sheet) this.$sheet[0].classList.toggle('fullscreen');

        this.controller.toggleFullscreen(this);
    },

    fullscreen: function fullscreen(yes) {

        this.isFullscreen = yes !== false;

        if (this.$sheet) this.isFullscreen ? this.$sheet[0].classList.add('fullscreen') : this.$sheet[0].classList.remove('fullscreen');
    },

    toggleFullscreenAPI: function toggleFullscreenAPI() {
        Util.toggleFullscreen(this.$sheet[0] /*, this.fullscreen.bind(this)*/);
    },

    updateTitle: function updateTitle() {
        if (!this.setTitleOnOpen) console.warn('Cannot update title. Please provide a `setTitleOnOpen` method.');else this.setTitle(this.setTitleOnOpen());
    },

    // override default spin...sheet views will spin in the center
    spin: function spin(keepSpinning, cancelCallback) {

        //make sure we have a view (sop dashboard broke)
        if (!this.$_inner) this._setView();
...
},{"./View":"../src/View.js","./Util":"../src/Util.js"}],"../src/SheetsController.js":[function(require,module,exports) {
/* ==============================
    Sheets Controller
...
module.exports = Backbone.View.extend({
    ...
    initialize: function initialize() {
        ...
        if (SheetView.prototype.controller) return console.warn('A SheetsController already exists');
    ...
    open: function open(sheet) {
        ...
        if (this.sheets.length == 0) this.show();else {
            var lastSheet = _.find(_.clone(this.sheets).reverse(), function (v) {
                return !v.isSplitView;
            });

            if (lastSheet.isFullscreen && !sheet.isFullscreen) sheet.toggleFullscreen();else if (!lastSheet.isFullscreen && sheet.isFullscreen) sheet.toggleFullscreen();
        }
    ...
    closeFromIndex: function closeFromIndex(indx) {
    ...
    setHash: function setHash() {
        ...
        if (hash) {
            ...
            if (app) document.title = this._defaultTitle;
        }

        if (window.isElectron && window.setWindowTitle) window.setWindowTitle();
    },
    ...
    toggleFullscreen: function toggleFullscreen(sheet) {

        if (!sheet.isFullscreen) _.each(this.sheets, function (v) {
            v.fullscreen(false);
        });
    }

});
},{"./SheetView":"../src/SheetView.js"}],"../src/App.js":[function(require,module,exports) {
/*
    Backbone Groundwork
...
module.exports = {
    ...
    MenuControllerView: require('./MenuControllerView'),
    SheetsController: require('./SheetsController'),
    SheetView: require('./SheetView'),
    Util: require('./Util'),
    Sounds: require('./Sounds')

};
},{"./View":"../src/View.js","./MenuController":"../src/MenuController.js","./MenuControllerView":"../src/MenuControllerView.js","./SheetsController":"../src/SheetsController.js","./SheetView":"../src/SheetView.js","./Util":"../src/Util.js","./Sounds":"../src/Sounds.js"}],"view1.js":[function(require,module,exports) {

var Backbone = require('backbone');
var SheetView = require('../src/SheetView');
var MenuController = require('../src/MenuController');
var MenuControllerView = require('../src/MenuControllerView');

var About = MenuControllerView.extend({
	...
	showProgress: function showProgress() {
		...
		this.progressInterval = setInterval(function () {
			_this.parent('view-1').progress(100, i++, true);
			if (i > 100) clearInterval(_this.progressInterval);
		}, 50);
	}
});

var MenuView = MenuController.extend({
...
module.exports = SheetView.extend({
	...
	openView2: function openView2() {
		this.parent('root.view-2').open();
	},
	openView3: function openView3() {
		this.parent('root.view-3').open();
	}
});
},{"backbone":"../node_modules/backbone/backbone.js","../src/SheetView":"../src/SheetView.js","../src/MenuController":"../src/MenuController.js","../src/MenuControllerView":"../src/MenuControllerView.js"}],"index.js":[function(require,module,exports) {
...
require('backbone-dropdown/src/jquery-plugin');
...
var View2 = App.SheetView.extend({
	title: 'View 2',
...
var View3 = App.SheetView.extend({
	title: 'View 3'
});
...
app.sv('view-2', View2);
app.sv('view-3', View3);
},{"jquery":"../node_modules/jquery/dist/jquery.js","underscore":"../node_modules/underscore/underscore.js","underscore.string":"../node_modules/underscore.string/lib/underscore.string.js","backbone":"../node_modules/backbone/backbone.js","kjantzer-backbone-subviews":"../node_modules/kjantzer-backbone-subviews/index.js","backbone-dropdown":"../node_modules/backbone-dropdown/src/dropdown.js","backbone-dropdown/src/jquery-plugin":"../node_modules/backbone-dropdown/src/jquery-plugin.js","../src/App":"../src/App.js","./view1":"view1.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/demo.fd8eb96e.map