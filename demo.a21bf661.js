...
},{"./Sounds":"../src/Sounds.js"}],"../src/Util.js":[function(require,module,exports) {
/*
    Utility Methods used accross App Framework components
*/
...
module.exports = Util;
},{"./Sounds":"../src/Sounds.js"}],"../src/MenuControllerView.js":[function(require,module,exports) {
/*
    ...
    _renderMenu: function _renderMenu() {
        ...
        if (menuOrder) {
            menuOrder.forEach(function (indx) {
                return _this.views[indx] && _this.views[indx].$menu && _this.views[indx].$menu.appendTo(_this.$menu);
            });
            // insert any remaining views (new views since last saved order)
            this.views.forEach(function (d, indx) {
                return menuOrder.indexOf(String(indx)) == -1 && d.$menu && d.$menu.appendTo(_this.$menu);
            });

            // insert views in order they are defined
        } else {
            this.views.forEach(function (d) {
                if (d.$menu) d.$menu.appendTo(_this.$menu);else if (d.permissionDenied !== true) // permission denied views wont have a $menu
                    _this.$menu.append(d.View.render().el);
            });
        }
    },
...
var dropdownPlugins = require('backbone-dropdown/src/jquery-plugin');
for (var key in dropdownPlugins) {
...
//# sourceMappingURL=/demo.a21bf661.map