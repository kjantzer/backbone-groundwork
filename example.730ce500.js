...
},{"./View":"../src/View.js","./MenuController":"../src/MenuController.js","./MenuControllerView":"../src/MenuControllerView.js","./SheetsController":"../src/SheetsController.js","./SheetView":"../src/SheetView.js","./Util":"../src/Util.js","./Sounds":"../src/Sounds.js"}],"index.js":[function(require,module,exports) {

// import and make these libraries global (Backbone, Underscore, jQuery)
window.jQuery = window.$ = require('jquery');
window._ = require('underscore');
_.mixin(require('underscore.string').exports());
window.Backbone = require('backbone');

// extend Backbone with subviews
require('kjantzer-backbone-subviews');

// import the Dropdown module (and the jQuery plugin)
window.Dropdown = require('backbone-dropdown');
var dropdownPlugins = require('backbone-dropdown/src/jquery-plugin');

// get all the Groundwork views
window.App = require('../src/App');

var View = App.SheetView.extend({
	title: 'Example'
});

// a sheets controller is required in order to show sheet views
window.app = new App.SheetsController();
document.body.append(app.render().el);

// create an open a view now
window.view = new View();
view.open();
},{"jquery":"../node_modules/jquery/dist/jquery.js","underscore":"../node_modules/underscore/underscore.js","underscore.string":"../node_modules/underscore.string/lib/underscore.string.js","backbone":"../node_modules/backbone/backbone.js","kjantzer-backbone-subviews":"../node_modules/kjantzer-backbone-subviews/index.js","backbone-dropdown":"../node_modules/backbone-dropdown/src/dropdown.js","backbone-dropdown/src/jquery-plugin":"../node_modules/backbone-dropdown/src/jquery-plugin.js","../src/App":"../src/App.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/example.730ce500.map